...
function [EP,y] = moead (CostFunction, VarSize, VarMin, VarMax, nObj)
%% MOEA/D Settings
...
for i = 1:nPop
    pop(i).Position = Gen_binary_solution(VarSize);
...
for it = 1:MaxIt
    for i = 1:nPop
        ...
        y = empty_individual;
        y.Position = Crossover_(p1.Position, p2.Position, crossover_params);
